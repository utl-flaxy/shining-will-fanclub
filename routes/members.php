...
Route::middleware(['web', 'auth', 'role:user'])
    ...
    ->group(function () {
        ...
        Route::prefix('items')->name('items.')->group(function () {
            ...
            Route::get('/my', [ItemsController::class, 'owned'])->name('my');
        ...
        Route::prefix('settings')->name('settings.')->group(function () {
            ...
            /* ===== パスワード変更 ===== */
            Route::get('/password', [SettingsController::class, 'password'])
                ->name('password');
            ...
            /* ===== 購入履歴 ===== */
            Route::get('/purchases', [SettingsController::class, 'purchaseHistory'])
                ->name('purchases');

            /* ===== テーマ ===== */
            Route::get('/themes', [SettingsController::class, 'themes'])
                ->name('themes');

            Route::post('/themes/apply', [SettingsController::class, 'applyTheme'])
                ->name('themes.apply');
